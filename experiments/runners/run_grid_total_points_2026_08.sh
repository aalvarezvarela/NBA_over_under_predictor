#!/usr/bin/env bash
# Eight experiments, sequential on one CUDA machine: six total-points horizon
...
# together: six total-points horizon cells plus two of the four classifier cells.
...
#
#   bash experiments/runners/run_grid_total_points_2026_08.sh
#
# Detached:
#   nohup bash experiments/runners/run_grid_total_points_2026_08.sh > /dev/null 2>&1 &
#
# Resume after an interruption without repeating completed cells:
#   SKIP_EXISTING=1 bash experiments/runners/run_grid_total_points_2026_08.sh
#
...
CAMPAIGN="grid_total_points_2026_08"
...
CONFIGS=(
  "$CONFIG_DIR/a_classifier_intermediate_t720.yaml"
  "$CONFIG_DIR/b_classifier_intermediate_t120.yaml"
  "$CONFIG_DIR/c_total_points_intermediate_t0.yaml"
  "$CONFIG_DIR/d_total_points_intermediate_t30.yaml"
  "$CONFIG_DIR/e_total_points_intermediate_t60.yaml"
  "$CONFIG_DIR/f_total_points_intermediate_t180.yaml"
  "$CONFIG_DIR/g_total_points_intermediate_t300.yaml"
  "$CONFIG_DIR/h_total_points_intermediate_t480.yaml"
)
