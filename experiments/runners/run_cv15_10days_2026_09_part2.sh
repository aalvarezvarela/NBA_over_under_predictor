#!/usr/bin/env bash
# Part 2: intermediate at T-360 minutes, schema 2.2. Experiments run sequentially; this runner never saves a production model.
set -euo pipefail
cd "$(dirname "$0")/../.."
...
CONFIGS=(
  "$CONFIG_DIR/d_t360_spread_2_2.yaml"
  "$CONFIG_DIR/e_t360_total_points_2_2.yaml"
  "$CONFIG_DIR/f_t360_line_error_2_2.yaml"
)
...
log "Intermediate T-360: floor 2019; available snapshot data starts in 2021."
log "Logs: $LOG_DIR"
