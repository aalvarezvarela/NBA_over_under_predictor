...
def process_player_statistics_for_training(
    df_players, df_team, df_injuries, older_limit_to_include, recent_limit_to_include
):
    """
    ...
    df_players = filter_by_date_range(df_players, older_limit_to_include, recent_limit_to_include)
