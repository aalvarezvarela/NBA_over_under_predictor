...
def schema_exists(schema_name: str = None) -> bool:
    ...
    try:
        if schema_name is None:
            schema_name = get_schema_name_games()
        ...
        with conn.cursor() as cur:
            ...
            create_table_query = sql.SQL(  # TODO: Fix HOME column to poorly calculated
                ...
                CREATE TABLE IF NOT EXISTS {}.{} (
                    ...
                    min INTEGER,
                    pts INTEGER NOT NULL CHECK (pts > 40),
                    fgm INTEGER,
                    fga INTEGER,
                    fg_pct NUMERIC(5, 3),
                    fg3m INTEGER,
...
if __name__ == "__main__":
    ...
    from nba_ou.postgre_db.games.creation.combine_games_data import (
        combine_all_nba_games,
    )
    ...
    if df_all_games is not None:
        ...
        upload_games_data_to_db(df_all_games)
    else:
